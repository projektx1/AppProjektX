...
ActiveRecord::Schema.define(version: 20150317231140) do
  ...
  create_table "contests", force: :cascade do |t|
    t.string   "contestName",          limit: 255, null: false
    t.string   "shortDescription",     limit: 255, null: false
    t.string   "fullDescription",      limit: 255, null: false
    t.datetime "beginDate",                        null: false
    t.datetime "endDate",                          null: false
    t.datetime "creationDate"
    t.boolean  "isActive",             limit: 1
    t.boolean  "isStandardMode",       limit: 1
    t.boolean  "isPromotedMode",       limit: 1
    t.boolean  "isVIPMode",            limit: 1
